...
#show: exzellenz-tum-thesis.with(
  ...
  titleEn: "Thesis Proposal: Extension of Pacing Diagram and Pacing Analysis in p:xe",
...
#include "proposal-2/01-introduction.typ"
#include "proposal-2/02-approach.typ"
#include "proposal-2/03-timeline.typ"
